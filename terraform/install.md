...
| <a name="input_extra_arguments"></a> [extra\_arguments](#input_extra_arguments)                                           | Extra arguments to pass to the nixos-anywhere script.                                                                                                                | `list(string)`                                                            | `[]`                                                                         |    no    |
...
| <a name="input_use_nixos_anywhere_from_path"></a> [use\_nixos\_anywhere\_from\_path](#input_use_nixos_anywhere_from_path) | n/a                                                                                                                                                                  | `bool`                                                                    | `false`                                                                      |    no    |
