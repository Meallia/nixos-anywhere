...
| <a name="input_lock_file"></a> [lock\_file](#input_lock_file)             | If set, use this file path as a lock to serialize nix builds (prevents parallel execution) | `string`      | `null`  |    no    |
